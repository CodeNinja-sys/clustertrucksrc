...
namespace InControl
{
	...
	public struct KeyInfo
	{
		...
		// Token: 0x060001D7 RID: 471 RVA: 0x0000A8B8 File Offset: 0x00008AB8
		...
		// (get) Token: 0x060001D9 RID: 473 RVA: 0x0000B908 File Offset: 0x00009B08
		...
		// (get) Token: 0x060001DA RID: 474 RVA: 0x0000B948 File Offset: 0x00009B48
		public string Name
		{
			get
			{
				if (Application.platform == RuntimePlatform.OSXEditor || Application.platform == RuntimePlatform.OSXPlayer || Application.platform == RuntimePlatform.OSXWebPlayer || Application.platform == RuntimePlatform.OSXDashboardPlayer)
				{
					return this.macName;
				}
				return this.name;
		...
		// (get) Token: 0x060001DB RID: 475 RVA: 0x0000B990 File Offset: 0x00009B90
		public Key Key
		{
			get
			{
