...
Keywords { "AC_QUALITY_STANDARD" }
					...
					//
					    ...
					    add r1.xyz, -r4, c1.w
					    mul_pp r2.xyz, r4, c3.w
					    mad_pp r3.xyz, r4, c4.x, c4.y
					    log_pp r4.x, r3.x
					    log_pp r4.y, r3.y
					    log_pp r4.z, r3.z
					    mul_pp r3.xyz, r4, c4.z
					    exp_pp r4.x, r3.x
					    exp_pp r4.y, r3.y
					    exp_pp r4.z, r3.z
...
Keywords { "AC_QUALITY_STANDARD" }
					...
					//
					    ...
					    texld_pp r3, r0, s1
					    texld_pp r2, r2, s1
					    lrp_pp r4.xyz, r0.w, r2, r3
					    add r0.xyz, -r4, c1.w
					    mul_pp r2.xyz, r4, c2.w
					    mad_pp r3.xyz, r4, c4.x, c4.y
					    log_pp r4.x, r3.x
					    log_pp r4.y, r3.y
					    log_pp r4.z, r3.z
