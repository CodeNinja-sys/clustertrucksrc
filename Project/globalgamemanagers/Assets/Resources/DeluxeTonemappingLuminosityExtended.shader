...
"ps_3_0
					...
					//
					    ...
					    ps_3_0
					    def c9, -1, 1, 0.200000003, -0.0250000004
					    def c10, 0, 0.298999995, 0.587000012, 0.114
					    dcl_texcoord_pp v0.xy
					    dcl_2d s0
					    mov r0.xy, c9
					    mad_pp r0.zw, c6.xyxy, r0.xyyx, v0.xyxy
					    texld_pp r1, r0.zwzw, s0
					    add_pp r0.zw, -c6.xyxy, v0.xyxy
					    texld_pp r2, r0.zwzw, s0
					    mad_pp r0.xy, c6, r0, v0
					    texld_pp r0, r0, s0
					    add_pp r3.xy, c6, v0
					    texld_pp r3, r3, s0
					    add_pp r0.xyz, r0, r3
					    ...
					    add_pp r0.xyz, r2, r0
					    add_pp r0.xyz, r1, r0
					    mad_pp r0.xyz, r0, -c9.z, r3
					    max_pp r1.xyz, r0, c9.w
					    min r0.xyz, r1, -c9.w
					    mad_pp r0.xyz, r0, c7.x, r3
					    mov_pp oC0.w, r3.w
					    max_pp r1.xyz, r0, c10.x
					    dp3_pp r0.x, r1, c10.yzww
					    lrp_pp r2.xyz, c8.x, r1, r0.x
					    dp3_pp r0.x, r2, c10.yzww
					    add r0.y, -r0.x, c3.x
					    mov r1, c0
					    cmp r1, r0.y, r1, c1
					    mov r3.x, c10.x
					    ...
					    rcp r0.w, r0.w
					    mad_sat r0.y, r0.z, r0.w, r0.y
					    rcp r0.z, c5.x
					    mad r0.z, r0.x, r0.z, c9.y
					    rcp r0.x, r0.x
...
"ps_4_0
					...
					void main()
					{
					    ...
					    u_xlat5.x = u_xlat12 / _LuminosityWhite;
...
Keywords { "FTD_DISABLE_CGRADING" }
					...
					//
					    ...
					    rcp r1.w, r1.w
					    mad_sat r1.y, r1.z, r1.w, r1.y
					    rcp r1.z, c5.x
					    mad r1.z, r1.x, r1.z, c7.x
					    rcp r1.x, r1.x
...
Keywords { "FTD_DISABLE_CGRADING" }
					...
					void main()
					{
					    ...
					    u_xlat7.x = u_xlat1 / _LuminosityWhite;
...
"ps_3_0
					...
					//
					    ...
					    ps_3_0
					    def c11, -1, 1, 0.200000003, -0.0250000004
					    def c12, 0, 0.298999995, 0.587000012, 0.114
					    dcl_texcoord_pp v0.xy
					    dcl_2d s0
					    dcl_volume s1
					    mov r0.xy, c11
					    ...
					    dp3_pp r0.x, r1, c12.yzww
					    lrp_pp r2.xyz, c8.x, r1, r0.x
					    dp3_pp r0.x, r2, c12.yzww
					    add r0.y, -r0.x, c3.x
					    mov r1, c0
					    cmp r1, r0.y, r1, c1
					    mov r3.x, c12.x
					    ...
					    exp r2.y, r1.y
					    exp r2.z, r1.z
					    mad r1.xyz, r2, c9.y, c9.z
					    texld r1, r1, s1
					    mad r1.xyz, r1, r1, -r0
					    mad_pp r0.xyz, c9.x, r1, r0
					    mul_pp oC0.xyz, r0, c4
...
Keywords { "FTD_2D_LUT" }
					...
					//
					    ...
					    texld_pp r1, r1, s0
					    mov r2.xy, c11
					    mad_pp r2, c6.xyxy, r2.xyyx, v0.xyxy
					    texld_pp r3, r2, s0
					    ...
					    exp r2.y, r1.x
					    exp r0.w, r1.z
					    mul r1.xy, r2.yzzw, c9.w
					    mov r2.yz, c9
					    mul r1.zw, r2.xyyz, c13.x
					    mad r1.yz, r1.xxyw, c9, r1.xzww
					    mul r1.w, r0.w, c9.w
					    frc r2.x, r1.w
					    add r1.w, r1.w, -r2.x
					    mad r1.x, r1.w, c9.z, r1.y
					    mad r0.w, r0.w, c9.w, -r1.w
					    mad r1.yw, r2.z, c13.xyzz, r1.xxzz
					    texld r2, r1.xzzw, s1
					    texld r1, r1.ywzw, s1
					...
					// approximately 60 instruction slots used (7 texture, 53 arithmetic)"
}
SubProgram "d3d11 " {
Keywords { "FTD_2D_LUT" }
					"ps_4_0
...
Keywords { "FTD_DISABLE_CGRADING" }
					...
					void main()
					{
					    ...
					    u_xlat4 = u_xlat4 + u_xlat7.x;
					    u_xlat4 = clamp(u_xlat4, 0.0, 1.0);
					    u_xlat7.x = u_xlat1.x / _LuminosityWhite;
					    u_xlat7.x = u_xlat7.x + 1.0;
					    u_xlat4 = u_xlat7.x * u_xlat4;
...
Keywords { "FTD_2D_LUT" "FTD_DISABLE_CGRADING" }
					...
					//
					    ...
					    mov r2.yz, c6
					    mul r1.zw, r2.xyyz, c9.y
					    mad r1.yz, r1.xxyw, c6, r1.xzww
					    mul r1.w, r0.w, c6.w
					    frc r2.x, r1.w
					    add r1.w, r1.w, -r2.x
					    mad r1.x, r1.w, c6.z, r1.y
					    mad r0.w, r0.w, c6.w, -r1.w
					    mad r1.yw, r2.z, c9.xxzz, r1.xxzz
					    texld r2, r1.xzzw, s1
					    texld r1, r1.ywzw, s1
					    lrp r3.xyz, r0.w, r1, r2
					    mad r1.xyz, r3, r3, -r0
